========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : dispmfc
========================================================================


AppWizard が生成した dispmfc には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには dispmfc を構成している各ファイルの概要説明が含まれています。
...
dispmfc.h
    ...
    みます） をインクルードし、また CDispmfcApp アプリケーションクラスを宣
    言します。

dispmfc.cpp
    このファイルは CDispmfcApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\dispmfc.ico
    ...
    ルです。このアイコンはリソース ファイル dispmfc.rc によってインクルード
    されます。
...
dispmfcDlg.h, dispmfcDlg.cpp - ダイアログ
    これらのファイルは CDispmfcDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な dispmfc.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) dispmfc.pch 
